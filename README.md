# Spatter 
This is a microbenchmark for timing Gather/Scatter kernels on CPUs and GPUs. View the [source](https://github.com/hpcgarage/spatter), and please submit an issue on Github if you run into any issues. Please also feel free to review our latest paper submission on [arXiv](https://arxiv.org/abs/1811.03743) for some experimental results and more discussion of the tool. If you use Spatter in your work, please cite it from the ArXiv bibtex listing.
