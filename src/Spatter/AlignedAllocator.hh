...
class aligned_allocator
{
	public:
		...
		T * allocate(const std::size_t n) const
		{
			...
			// std::aligned_alloc will return NULL if you try to allocate less bytes than the alignment
			// So long as the above test against max_size() passes, this multiplication is safe.
